...
export const WizardForm = () => {
  ...
  const surveyAnswers = [step1NameValues, step1Values, step2Values,  step3Values, step4Values, step4LocationValues, step3ProjectsValues, avatarUrl, step2GithubValues, step2LinkedInValues];
    ...
    <>
      ...
      <form>
        ...
        {step === 2 && (
          ...
          <Step2Github state={step2GithubValues} onChange={handleStep2GithubChange} />
          <Step2LinkedIn state={step2LinkedInValues} onChange={handleStep2LinkedInChange} />
          </div>
          </div>
        )}
        {step === 3 && (
